...
# mass relative to its structural size (bill length, bill depth, and flipper 
# length). Use lm() to fit a regression and resid() to get the residuals. 
# Normalize by mean body mass.
